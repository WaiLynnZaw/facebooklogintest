    ...
    public void getAccountInfo(View view){
        AccountKit.getCurrentAccount(new AccountKitCallback<Account>() {
            ...
            public void onSuccess(final Account account) {
                ...
                String phoneNumberString = String.format("%s - %s",accountKitId,phoneNumber.toString());
                TextView acc_info = (TextView) findViewById(R.id.tv_acc_info);
                acc_info.setText(phoneNumberString);
